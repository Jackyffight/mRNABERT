...
class TrainingArguments(transformers.TrainingArguments):
    num_train_epochs: int = field(default=8, metadata={"help": "Total number of training epochs to perform."})
...
def main():
    ...
    if model_args.tokenizer_name:
        ...
        tokenizer = AutoTokenizer.from_pretrained(model_args.model_name_or_path, **tokenizer_kwargs,model_max_length=1024,trust_remote_code=True)
    else:
        raise ValueError(
